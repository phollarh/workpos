...
urlpatterns = [
    ...
    path('Update_profile_picture/<int:pk>', views.Update_profile_picture, name='Update_profile_picture'),
    ...
    path('change_outlet_logo/<int:pk>', views.change_outlet_logo, name='change_outlet_logo'),
